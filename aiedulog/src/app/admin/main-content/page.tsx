        ...
        <Paper sx={{ width: '100%' }}>
          ...
          <TabPanel value={tabValue} index={0}>
            <Box sx={{ p: 3 }}>
              ...
              <List>
                {navigationItems.filter(item => !item.parent_key).map((item) => (
                  <Box key={item.id}>
                    <ListItem>
                      <ListItemText 
                        primary={item.label}
                        secondary={item.is_dropdown ? '드롭다운 메뉴' : `링크: ${item.href || '없음'}`}
                      />
                      <ListItemSecondaryAction>
                        ...
                        {navigationItems
                          ...
                          .map(subItem => (
                            <ListItem key={subItem.id}>
                              ...
                              />
                              <ListItemSecondaryAction>
                                <IconButton size="small" onClick={() => handleEditNavItem(subItem)}>
                                  <Edit fontSize="small" />
                                </IconButton>
                              </ListItemSecondaryAction>
                            </ListItem>
              ...
              <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                  ...
                  <TextField
                    ...
                    onChange={(e) => setHeroContent({ ...heroContent, primary_button_href: e.target.value })}
                    sx={{ mb: 2 }}
                  />
                  <TextField
                    fullWidth
          ...
          <TabPanel value={tabValue} index={3}>
            <Box sx={{ p: 3 }}>
              <Typography variant="h6" sx={{ mb: 3 }}>페이지 콘텐츠 관리</Typography>
