...
export const SIZE_PRESETS = [
  { label: 'Mobile', value: 'mobile' as EmbedSizeState['size'], icon: '📱' },
  { label: 'Tablet', value: 'tablet' as EmbedSizeState['size'], icon: '📱' },
  { label: 'Small', value: 'small' as EmbedSizeState['size'], icon: '💻' },
  { label: 'Medium', value: 'medium' as EmbedSizeState['size'], icon: '💻' },
  { label: 'Large', value: 'large' as EmbedSizeState['size'], icon: '🖥️' },
  { label: 'X-Large', value: 'xlarge' as EmbedSizeState['size'], icon: '📺' },
  { label: 'Custom', value: 'custom' as EmbedSizeState['size'], icon: '⚙️' }
]
