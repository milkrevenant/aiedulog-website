          ...
          <label htmlFor="image-upload">
            <M3Box sx={{ cursor: 'pointer' }}>
              {uploading ? (
                ...
                <>
                  <M3Box sx={{ fontSize: '48px', color: 'var(--md-sys-color-primary)', marginBottom: '8px' }}>
                    <M3Icon>cloud_upload</M3Icon>
                  </M3Box>
                  <M3Typography variant="title-large" sx={{ marginBottom: '8px' }}>
                    이미지 업로드
                  </M3Typography>
                  <M3Typography variant="body-medium" sx={{ color: 'var(--md-sys-color-on-surface-variant)' }}>
                    클릭하거나 파일을 드래그하세요
                  </M3Typography>
                  <M3Typography variant="label-small" sx={{ color: 'var(--md-sys-color-on-surface-variant)', display: 'block', marginTop: '8px' }}>
                    JPG, PNG, GIF, WebP (최대 5MB)
                  </M3Typography>
                  <M3Typography variant="label-small" sx={{ color: 'var(--md-sys-color-on-surface-variant)' }}>
